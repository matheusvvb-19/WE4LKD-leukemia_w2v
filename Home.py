...
if __name__ == '__main__':
    ...
    st.markdown('This project is fully funded by the Fundação de Amparo à Pesquisa do Estado de São Paulo (FAPESP, Brazil), under identification code 2021/13054-8.\nUndergraduate scholarship student: Matheus Vargas Volpon Berto.<br>Professor and supervisor: Dr. Tiago Almeida.<br>Educational institution: Federal University of São Carlos (UFSCar) - Sorocaba campus.')
