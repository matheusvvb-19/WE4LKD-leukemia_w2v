...
def clean_file(file_path):
    ...
    synonyms_gemtuzumab_ozogamicina = ['cma-676', 'gemtuzumab-ozogamicin', 'mylotarg', 'cma676',
                       'cma 676', 'gemtuzumab ozogamicin'
    ]
    ...
    for s in summaries:
        ...
        s = re.sub("|".join(sorted(synonyms_gemtuzumab_ozogamicina, key = len, reverse = True)), 'gentuzumab ozogamicina', s)
